...
import com.fernando.bookstore.dtos.CategoriaDTO;
...
public class CategoriaService {
    ...
    public void delete(Integer id){
        ...
        try{
            ...
            throw new com.fernando.bookstore.service.exceptions.DataIntegrityViolationException("Categoria não pode ser deletada!" +
